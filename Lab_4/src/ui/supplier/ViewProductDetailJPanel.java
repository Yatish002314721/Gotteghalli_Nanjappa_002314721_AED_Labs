...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewProductDetailJPanel(JPanel workArea, Product product) {
        ...
        if (product.getProductImage()!= null) imgProduct.setIcon(product.getProductImage());
        else imgProduct.setText("No image");
    ...
    private void initComponents() {
        ...
        lblTitle.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        ...
        lblPrice.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        ...
        btnUpdate.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        ...
        backButton1.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        ...
        lblId.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        lblId.setForeground(new java.awt.Color(0, 51, 153));
        lblId.setText("ID:");

        btnSave.setBackground(new java.awt.Color(204, 255, 204));
        btnSave.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        ...
        tblFeatures.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        tblFeatures.setForeground(new java.awt.Color(102, 0, 0));
        ...
        btnAddFeature.setBackground(new java.awt.Color(204, 255, 204));
        btnAddFeature.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        btnAddFeature.setForeground(new java.awt.Color(102, 0, 0));
        ...
        btnRemoveFeature.setBackground(new java.awt.Color(204, 255, 204));
        btnRemoveFeature.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        btnRemoveFeature.setForeground(new java.awt.Color(102, 0, 0));
