...
public class SearchForProductJPanel extends javax.swing.JPanel {
   ...
   Supplier supplier;
    ...
    private void initComponents() {
        ...
        lblProductId.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        lblProductId.setForeground(new java.awt.Color(0, 51, 153));
        lblProductId.setText("Product Id:");

        idField.setBackground(new java.awt.Color(204, 255, 204));

        searchButton.setBackground(new java.awt.Color(204, 255, 204));
        searchButton.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        ...
        jButton1.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
       ...
       String searchKeyText = idField.getText();
        int searchKey;
        try {
            searchKey = Integer.parseInt(searchKeyText);
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Invalid input. Please enter a valid integer.");
            return;
        }
        for (Product p : supplier.getProductCatalog().getProductCatalog()) {
            if (searchKey == p.getId()) {
        ...
        JOptionPane.showMessageDialog(this, "No products found with this id"); 
