...
//      masterOrderCatalog = moc;
    ...
    private void initComponents() {
        ...
        btnLogOut.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        btnLogOut.setForeground(new java.awt.Color(102, 0, 0));
        ...
        lblWelcome.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        ...
        btnManageProductCatalog.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        ...
        btnUpdateSupplierProfile.setBackground(new java.awt.Color(204, 255, 204));
        btnUpdateSupplierProfile.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        btnUpdateSupplierProfile.setForeground(new java.awt.Color(102, 0, 0));
        ...
        btnManageStaff.setBackground(new java.awt.Color(204, 255, 204));
        btnManageStaff.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        btnManageStaff.setForeground(new java.awt.Color(102, 0, 0));
        btnManageStaff.setText("Manage Staff");

        btnPerformance.setBackground(new java.awt.Color(204, 255, 204));
        btnPerformance.setFont(new java.awt.Font("Kannada MN", 1, 13)); // NOI18N
        btnPerformance.setForeground(new java.awt.Color(102, 0, 0));
