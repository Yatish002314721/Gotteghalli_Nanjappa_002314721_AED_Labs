...
public class ManageAccountsJPanel extends javax.swing.JPanel {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(selectedRow>=0){
            ...
            JOptionPane.showMessageDialog(null, "Please select an account from list.", "warning", JOptionPane.WARNING_MESSAGE);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        if(!txtSearchBox.getText().isBlank()){
                ...
                userProcessContainer.add("ViewAccountPanle", panel);
                CardLayout layout = (CardLayout) userProcessContainer.getLayout();
                layout.next(userProcessContainer);
            }else{
